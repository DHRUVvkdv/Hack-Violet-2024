...
const MenstrualCyclePage = () => {
  const phases = ['Menstration', 'Follicular', 'Ovulation', 'Luteal'];
  ...
  const generalFoodData = {
    Menstration: "Increase your intake of iron rich foods and vitamin C. Drink soothing tea, to combat cramps. Avoid or limit fatty foods, alcohol, caffeine, and salty foods.",
    Follicular: '',
    Ovulation: '',
    Luteal: ''
  }
  ...
  const mealFoodData = {
    Menstration: "Grilled Salmon, Kale and sweet potato salad, Spicy sprouts, Broccoli and feta pasta salad",
    Follicular: '',
    Ovulation: '',
    Luteal: ''
  }
  ...
  const veganFoodData = {
    Menstration: "Chickpea and spinach curry, Sundried tomatoes and kidney bean chilli, Tofu tacos, Oatmeal cookies, Buddha bowl",
    Follicular: '',
    Ovulation: '',
    Luteal: ''
  }
